...
const ListView = () => {
    ...
    }, [Football, Mental, Gym,layeringClicked,Physical])
    return (
                    ...
                    <div className="Schedule-head-End">
                        <div className="sports-Icons">
                            <button className="Schedule-Button" onClick={()=>setPhysical(p=>!p)}>
                                 <FontAwesomeIcon style={{color:Physical ? '#F0E68C':'white'}} icon={faPerson} />  </button>
                            ...
                            <button className="Schedule-Button" onClick={()=>setGym(g=>!g)}>
                                 <FontAwesomeIcon style={{color:Gym ? '#F0E68C':'white'}} icon={faDumbbell} /> </button>
                            <button className="Schedule-Button" onClick={()=>setMental(m=>!m)}>
                                 <FontAwesomeIcon  style={{color:Mental ? '#F0E68C':'white'}}  icon={faUser} /> </button></div>
