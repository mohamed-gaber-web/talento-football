...
function ScheduleLineView() {
    ...
    useEffect(() => {
        console.log(filla);
    }, [Football,Mental,Gym,layeringClicked,openModal,filla])
            ...
            <div className="Schedule-head">
                ...
                <div className="Schedule-head-End">
                    ...
                    <div className="sports-Icons">
                        <button className="Schedule-Button" ><FontAwesomeIcon icon={faPerson} size="sm" /></button>
                        <button className="Schedule-Button" onClick={()=>setFootball(s=>!s)}><FontAwesomeIcon icon={faEarthAsia} size="sm" /></button>
                        <button className="Schedule-Button" onClick={()=>setGym(g=>!g)} ><FontAwesomeIcon icon={faDumbbell} size="sm" /></button>
                        <button className="Schedule-Button" onClick={()=>setMental(m=>!m)}><FontAwesomeIcon icon={faUser} size="sm" /></button></div>
